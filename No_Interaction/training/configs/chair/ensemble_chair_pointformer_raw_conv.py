...
agent = dict(
    ...
    policy_cfg=dict(
        ...
        loss_type='mse_loss',
        nn_cfg=dict(
            type='FastChairRPointFormer',
            stack_frame=1,
            num_objs='num_objs',
            pcd_pn_cfg=dict(
                type='FastRPointFormerCoreV0',
                conv_cfg=dict(
                    type='ConvMLP',
                    norm_cfg=None,
...
train_mfrl_cfg = dict(
    ...
    init_replay_with_split=[
        '/export2/home/v-yehl/dataset/ManiSkill/compressed_data/RefinePushChair/',
        '/export/home/v-yehl/net/RL/ManiSkill/mani_skill/assets/config_files/chair_models.yml'
    ])
env_cfg = dict(
    type='gym',
    unwrapped=False,
...
work_dir = './work_dirs/bc_transformer_raw_conv_smalllr_l2_chair/EnsembleBC'
