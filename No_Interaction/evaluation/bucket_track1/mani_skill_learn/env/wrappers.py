...
from .observation_process import process_mani_skill_base, chair_process_mani_skill_base, bucket_process_mani_skill_base
...
class SapienRLWrapper(ObservationWrapper):
    ...
    def observation(self, observation):
        ...
        if self.observation_type == 'chair':
            observation = chair_process_mani_skill_base(observation, self.env)
        elif self.observation_type == 'bucket':
            observation = bucket_process_mani_skill_base(observation, self.env)
        else:
