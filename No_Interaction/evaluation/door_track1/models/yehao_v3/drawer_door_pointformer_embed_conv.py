...
train_mfrl_cfg = dict(
    ...
    init_replay_with_split=[
        '/export/home/v-yehl/dataset/ManiSkill/compressed_data/OpenCabinetDoor/',
        '/export/home/v-yehl/net/RL/ManiSkill/mani_skill/assets/config_files/cabinet_models_door.yml'
    ])
env_cfg = dict(
    type='gym',
    unwrapped=False,
...
work_dir = './work_dirs/bc_transformer_embed_conv_l1_door/BC'
