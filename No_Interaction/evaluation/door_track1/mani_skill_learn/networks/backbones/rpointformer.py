...
class RPointFormerCoreV0(PointBackbone):
    def __init__(
        self, 
        conv_cfg, 
        mlp_cfg, 
        ...
        super(RPointFormerCoreV0, self).__init__()
    ...
    def forward_raw(self, point, state, mask, xyz, diff, dist, downsample_mask):
        B, N = point.shape[:2]
