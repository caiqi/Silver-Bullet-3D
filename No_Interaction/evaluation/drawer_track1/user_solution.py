...
def process_mani_skill_base(obs, obs_mode=None):
    ...
    if GLOBAL_ENV_NAME == "door" or GLOBAL_ENV_NAME == "drawer":
        return process_mani_skill_door_drawer(obs, obs_mode=obs_mode)
...
def process_mani_skill_door_drawer(obs, obs_mode=None):
    # obs: iterated dict,
...
class UserPolicy(BasePolicy):
    def __init__(self, env_name):
        ...
        bc_models = [
            # 89
            ["models_1230/1225_drawer_ensemble_v1/BC/1225_drawer_ensemble_v1.py",
                "models_1230/1225_drawer_ensemble_v3/BC/models/model_750000.ckpt"],
            # 90
            ["models_1230/ManiSkillModels4/drawer/model1/ensemble_drawer_door_pointformer_embed_conv.py",
                "models_1230/ManiSkillModels4/drawer/model1/model_300000.ckpt"],
            # 88
            ["models_1230/ManiSkillModels4/drawer/model2/ensemble_drawer_door_pointformer_embed_conv.py",
                "models_1230/ManiSkillModels4/drawer/model2/model_300000.ckpt"],
            # 88
            ["models_1230/1225_drawer_ensemble_v1/BC/1225_drawer_ensemble_v1.py",
                "models_1230/1229_drawer_ensemble_v6/BC/models/model_750000.ckpt"],
            # 91
            ["models_1230/version4/drawer/model1/ensemble_drawer_door_pointformer_embed_conv.py",
                "models_1230/version4/drawer/model1/model_750000.ckpt"],
            # 91
            ["models_1230/version4/drawer/model2/ensemble_drawer_door_pointformer_embed_conv.py",
                "models_1230/version4/drawer/model2/model_600000.ckpt"],
            # 88
            ["models_1230/version4/drawer/model3/ensemble_drawer_door_pointformer_embed_conv.py",
                "models_1230/version4/drawer/model3/model_300000.ckpt"],
        ]
        # bc_models = []
        dt_models = [
            ["models_1230/1209_drawer_single_v1/DT/1209_drawer_single_v1.py",
                "models_1230/1209_drawer_single_v1/DT/models/model_850000.ckpt"],
            ["models_1230/1209_drawer_single_v1/DT/1209_drawer_single_v1.py",
                "models_1230/1209_drawer_single_v1/DT/models/model_700000.ckpt"],
        ]
        # dt_models = []
        bc_agents = []
        for m in bc_models:
