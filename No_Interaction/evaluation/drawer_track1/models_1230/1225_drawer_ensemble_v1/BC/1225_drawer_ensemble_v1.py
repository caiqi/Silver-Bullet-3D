work_dir = '1225_drawer_ensemble_v1/BC'
log_level = 'INFO'
stack_frame = 1
num_heads = 4
agent = dict(
...
train_mfrl_cfg = dict(
    ...
    init_replay_with_split=[
        './full_mani_skill_data/compressed_data/OpenCabinetDrawer/',
        '/export/v-qcaii/darwin/ManiSkill/mani_skill/assets/config_files/cabinet_models_drawer.yml'
    ])
env_cfg = dict(
    type='gym',
    unwrapped=False,
    ...
    reward_type='dense',
    env_name='OpenCabinetDrawer-v0')
replay_cfg = dict(type='ReplayMemoryRGBIntNextActions', capacity=1000000)
